...
class _Config:
    def __init__(self):
        ...
        self.gpt_path = 'bert-base-uncased'  # if PTM is XLNet, this config will be modified to xlnet-base-cased in train/parse_arg_cfg()
        self.exp_no = 'test'
        self.mode = 'train'
        ...
        self.epoch_num = 5
        self.batch_size = 8  # will be modified to 1 while validating, but will still effect eval_batch_size
        self.seed = 11
        self.device = 0
        ...
        # Pick pretrain model from ['bert', 'xlnet']
        self.PTM = 'bert'
